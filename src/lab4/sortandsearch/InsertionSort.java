...
public class InsertionSort {
  ...
  /**
   * Assigns value of end index to start index and push every elements from start index (inclusive)
   * to end index (exclusive) one index to the right.
   */
