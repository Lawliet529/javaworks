...
public class TrigonometricSeries {
  ...
  public static void main(String[] args) {
    ...
    for (String key : valuesOfX.keySet()) {
      ...
      System.out.println(
          "Difference: " + (sin(valuesOfX.get(key), numTerms) - Math.sin(valuesOfX.get(key))));
      System.out.println("cos(" + key + ") = " + cos(valuesOfX.get(key), numTerms));
      System.out.println(
          "Difference: " + (cos(valuesOfX.get(key), numTerms) - Math.cos(valuesOfX.get(key))));
      System.out.println();
    }
  }
