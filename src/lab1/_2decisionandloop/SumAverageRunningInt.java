...
public class SumAverageRunningInt {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        "The sum of squares of " + LOWERBOUND + " to " + UPPERBOUND + " is " + sumOfSquares);

    System.out.println(
        "The sum of odd numbers from " + LOWERBOUND + " to " + UPPERBOUND + " is " + sumOdd);
    System.out.println(
