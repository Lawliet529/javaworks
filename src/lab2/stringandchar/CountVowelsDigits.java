...
public class CountVowelsDigits {
  ...
  public static void main(String[] args) {
    ...
    System.out.printf(
        "Number of vowels: %d (%.2f%%)%n", numVowels, (double) numVowels / inStr.length() * 100);
    System.out.printf(
        "Number of digits: %d (%.2f%%)%n", numDigits, (double) numDigits / inStr.length() * 100);
  }
}
